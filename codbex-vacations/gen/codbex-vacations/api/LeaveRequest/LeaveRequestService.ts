...
import { LeaveRequestRepository, LeaveRequestEntityOptions } from "../../dao/LeaveRequest/LeaveRequestRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-vacations-LeaveRequest-LeaveRequest", ["validate"]);
...
class LeaveRequestService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-vacations/gen/codbex-vacations/api/LeaveRequest/LeaveRequestService.ts/" + entity.Id);
