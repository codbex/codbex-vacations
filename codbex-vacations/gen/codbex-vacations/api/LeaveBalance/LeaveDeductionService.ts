...
class LeaveDeductionService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-vacations.LeaveBalance.LeaveDeductionReadOnly") || user.isInRole("codbex-vacations.LeaveBalance.LeaveDeductionFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-vacations.LeaveBalance.LeaveDeductionFullAccess")) {
            throw new ForbiddenError();
        }
    }
