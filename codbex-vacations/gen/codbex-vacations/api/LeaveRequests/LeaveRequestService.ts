...
class LeaveRequestService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-vacations.LeaveRequests.LeaveRequestReadOnly") || user.isInRole("codbex-vacations.LeaveRequests.LeaveRequestFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-vacations.LeaveRequests.LeaveRequestFullAccess")) {
            throw new ForbiddenError();
        }
    }
